...
JNIEXPORT void Java_com_gm_moon_calendar_MoonphaseCalculator_calcNative(JNIEnv * env, jobject this,
...
JNIEXPORT jint Java_com_gm_moon_calendar_MoonphaseCalculator_getSizeOfTimet(JNIEnv * env, jobject this) {
